...
*/
// SERVO PINs //////////////////////////////////////////////////////////////////////////////
#define PIN_YL 1 //servo[0]  left leg
#define PIN_YR 2 //servo[1]  right leg
#define PIN_RL 3 //servo[2]  left foot
#define PIN_RR 4 //servo[3]  right foot
// ULTRASONIC PINs /////////////////////////////////////////////////////////////////////////
...
void setup() {
  Serial.begin(19200);
  Otto.init(PIN_YL, PIN_YR, PIN_RL, PIN_RR, false, 0, PIN_Buzzer,PIN_Trigger, PIN_Echo); //Set the servo pins and Buzzer pin
  //Otto wake up!
